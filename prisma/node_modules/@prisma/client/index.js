...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\kaueb\\OneDrive\\Documents\\Cursos de Programação\\Projetos_para_treinar\\Angular_ToDoList-Devstackr\\prisma\\node_modules\\@prisma\\client",
      "fromEnvVar": null
    },
    "config": {
      "browser": "true",
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output          = \"./node_modules/@prisma/client\"\n  browser         = true\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\n// Definição do modelo Todo\nmodel Todo {\n  id        Int @id @default(autoincrement()) // Define o campo 'id' como identificador único\n  text     String    // Título da tarefa\n  completed Boolean    // Indica se a tarefa está completa ou não\n}\n",
  "inlineSchemaHash": "a3938bb7248786c598d14247f2b33c83ffb005e1a8dd7c4045151eb2cbdd4de9",
  "copyEngine": true
}
